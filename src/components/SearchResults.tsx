    ...
    <div>
      ...
      <form onSubmit={handleSearchSubmit} className="mb-6">
        <div className="relative">
          ...
          <button type="submit" className="absolute right-3 top-3 text-gray-500 dark:text-gray-400">
            <Search size={20} />
          </button>
        </div>
      </form>
      ...
      {isSearching ? (
        ...
        <div className="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-lg">
          <p className="text-gray-600 dark:text-gray-300 mb-3">No results found for "{query}"</p>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Try different keywords or browse categories</p>
          <button 
